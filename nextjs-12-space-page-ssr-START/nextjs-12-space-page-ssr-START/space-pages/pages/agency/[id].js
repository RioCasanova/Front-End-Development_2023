...
// making this server-side render
export async function getServerSideProps(context) {
  // get the agency with the id from context.params.id
  const agency = await getAgency(context.params.id);
  // pass it as a prop
...
export default function Agency(props) {
  ...
  const agencyDetails = props.agency;
