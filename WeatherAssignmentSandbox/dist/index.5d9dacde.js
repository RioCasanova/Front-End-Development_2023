...
})({"fxP4J":[function(require,module,exports) {
...
form.addEventListener("submit", (evt)=>{
    evt.preventDefault();
    (0, _base.getLocation)(inputValue).then((data)=>{
        (0, _base.getWeather)(data).then((weatherData)=>{
            (0, _weather.renderWeather)(weatherData, weatherContainer);
        });
    });
});
...
const getLocation = (cityName)=>{
    return fetch(`http://api.openweathermap.org/geo/1.0/direct?q=${cityName}&appid=${API_KEY}`).then((response)=>{
...
const getWeather = (data)=>{
    return fetch(`https://api.openweathermap.org/data/2.5/weather?lat=${data[0].lat}&lon=${data[0].lon}&appid=${API_KEY}`).then((response)=>{
        console.log(response.status);
        return response.json();
    }).then((data)=>{
        return data;
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"4K1kI"}],"4K1kI":[function(require,module,exports) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"4K1kI"}]},["fxP4J","1Z4Rq"], "1Z4Rq", "parcelRequire743a")
